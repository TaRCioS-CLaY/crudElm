...
var $author$project$Main$Model = F3(
	function (nome, idade, listaPessoas) {
...
var $author$project$Main$pessoaDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Pessoa,
...
var $author$project$Main$init = function (pList) {
...
var $author$project$Main$cadastrar = _Platform_outgoingPort(
	'cadastrar',
	function ($) {
...
var $author$project$Main$verificarStringInt = function (string) {
	return (string === '') ? 0 : A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toInt(
			A2($elm$core$String$filter, $elm$core$Char$isDigit, string)));
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Idade':
				var idade = msg.a;
				var _v1 = $elm$core$String$toInt(idade);
				if (_v1.$ === 'Just') {
					var idadeCerta = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{idade: idadeCerta}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								idade: $author$project$Main$verificarStringInt(idade)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Salvar':
...
var $author$project$Main$Nome = function (a) {
	return {$: 'Nome', a: a};
};
var $author$project$Main$Salvar = function (a) {
	return {$: 'Salvar', a: a};
};
...
var $author$project$Main$idadeIntToString = function (idade) {
	return (!idade) ? '' : $elm$core$String$fromInt(idade);
};
...
var $author$project$Main$linhaPessoa = function (pessoa) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('hero is-primary is-fullheight is-bold')
			]),
		_List_fromArray(
			[
				A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Events$onInput($author$project$Main$Nome)
													]),
												_List_Nil)
											]))
									])),
											...
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('input is-rounded '),
														$elm$html$Html$Attributes$type_('text'),
														$elm$html$Html$Attributes$placeholder('Idade'),
														$elm$html$Html$Attributes$value(
														$author$project$Main$idadeIntToString(model.idade)),
														$elm$html$Html$Events$onInput($author$project$Main$Idade)
													]),
												_List_Nil)
											]))
									])),
